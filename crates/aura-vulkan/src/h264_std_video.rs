...
mod tests {
    use super::*;
    use aura_media::h264_parser::H264Sps;
    ...
    fn maps_sps_to_std_video_struct() {
        ...
        assert_eq!(std.profile_idc, STD_VIDEO_H264_PROFILE_IDC_MAIN);
        assert_eq!(std.level_idc, STD_VIDEO_H264_LEVEL_IDC_3_1);
        assert_eq!(std.chroma_format_idc, STD_VIDEO_H264_CHROMA_FORMAT_IDC_420);
        assert_eq!(std.pic_order_cnt_type, STD_VIDEO_H264_POC_TYPE_2);
